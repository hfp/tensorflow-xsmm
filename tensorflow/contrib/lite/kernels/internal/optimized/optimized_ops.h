...
inline void LstmCell(
  ...
  output_state_map =
      input_gate_sm.unaryExpr(Eigen::internal::/*scalar_logistic_op*/scalar_sigmoid_op<float>()) *
          new_input_sm.tanh() +
      forget_gate_sm.unaryExpr(Eigen::internal::/*scalar_logistic_op*/scalar_sigmoid_op<float>()) *
          prev_state_map;
  output_activ_map =
      output_gate_sm.unaryExpr(Eigen::internal::/*scalar_logistic_op*/scalar_sigmoid_op<float>()) *
...
inline void Logistic(const RuntimeShape& input_shape, const float* input_data,
  ...
  auto output_map = MapAsVector(output_data, output_shape);
  output_map.array() =
      input_map.array().unaryExpr(Eigen::internal::/*scalar_logistic_op*/scalar_sigmoid_op<float>());
}
